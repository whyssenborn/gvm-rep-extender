...
def check_args(args: Namespace) -> None:
    ...
    the argument 'first_task'. If you would like to give the new con-  \
    tainer task a name add the argument 'name' at the end. After that  \
    place the wished name for the created container task.	
...
####-----------------Addition 1
    if 'name' in args.script:
        arg_len = args.script[1:-2]
####-----------------Addition 1 END
    else:
